	...
	return (
		<div>
			<main className="font-body p-8">
				...
				<Link
					href="/"
					className="font-bold underline cursor-pointer transition-all duration-200 ease-in-out hover:text-nice-blue"
				>
					Portfolio
				</Link>
				<p className="mb-4">
				...
				<p className="mb-4">
					A custom physical therapy solution for MS patients to
					improve hand mobility and remain active.
				</p>
				<a
				...
				<p className="mb-4">
					A Python command line recreation of the popular mobile game,
					Pokemon GO!
				</p>
				<a
				...
				<p className="mb-4">
					Scans parking lots with YOLOv8 and finds shortest routes
					using A* pathfinding.
				</p>
				<a
				...
				<p className="mb-4">
					Ship navigation system simulating and presenting data from a
					buoy network at a glance.
				</p>
			</main>
		</div>
	);
